...
def parse_args():
    ...
    parser.add_argument('--i0', type=int, default=0, help='start image')
    parser.add_argument('--i1', type=int, default=-1, help='end image (excluded')
...
if __name__ == '__main__':
    ...
    data_params['dataset_params']['i0'] = params.i0
    data_params['dataset_params']['i1'] = params.i1
